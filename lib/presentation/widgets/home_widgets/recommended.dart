                ...
                itemBuilder: (context, index) => InkWell(
                  onTap: () {
                    HomeCubit.get(context).getPlaceDetail(
                        context: context,
                        id: HomeCubit.get(context).recommended[index].id.toString());
                  },
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              HomeCubit.get(context).recommended[index].nameEN.toString(),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    (HomeCubit.get(context).recommended[index].city == null)? Text(
                                      "Cairo",
                                      style: headingStyle.copyWith(
                                          fontWeight: FontWeight.w500,
                                          color: Colors.white),
                                    )
                                    : HomeCubit.get(context).recommended[index].city
                                  ],
                                ),
                                Row(
                                  children: [
                                    Text(
                                      HomeCubit.get(context).recommended[index].rate.toString(),
                                      style: headingStyle.copyWith(
                                          fontWeight: FontWeight.w500,
                                          color: Colors.white),
                                    ),
